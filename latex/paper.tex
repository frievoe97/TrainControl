...
name=Fahrtverlauf,
description={Der Fahrtverlauf beschreibt die Positionen, Zeiten und Geschwindigkeiten für alle Beschleunigungs- und Bremsvorgänge und den \Gls{beharrungsfahrt}en eines Fahrzeugs von der aktuellen Position bis zum nächsten Halt.},
plural={Fahrtverläufe}
}
\newglossaryentry{echtzeitdaten}{
name=Echtzeitdaten,
description={Die Echtzeitdaten beschreiben für jedes Fahrzeug die Position und Geschwindigkeit bei Beschleunigungen und Verzögerungen in 2 $km/h$-Schritten und bei konstanter Geschwindigkeit in regelmäßigen Distanz-Intervallen in Abhängigkeit von der \Gls{simulationszeit}.}
}
